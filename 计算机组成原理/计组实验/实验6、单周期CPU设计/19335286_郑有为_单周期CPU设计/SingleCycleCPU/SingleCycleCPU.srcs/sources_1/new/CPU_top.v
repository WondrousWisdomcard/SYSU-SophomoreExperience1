...
module CPU_top(
    ...
    CPUControl CPUControl_test(Instruction,RegDst,Jump,Branch,MemRead,MemToReg,MemWrite,ALUSrc1,ALUSrc2,RegWrite);
      
    NextAddress NextAddress_test(Jump,Branch,Zero,CurAddress,Instruction,SignExtend,TempAddress);
    
    PC PC_test(clk,reset,TempAddress,CurAddress);
    
    InstructionMemory InstructionMemory_test(CurAddress,Instruction);
    
    Registers Registers_test(clk,Instruction,RegDst,RegWrite,WriteDataReg,ReadData1,ReadData2);
