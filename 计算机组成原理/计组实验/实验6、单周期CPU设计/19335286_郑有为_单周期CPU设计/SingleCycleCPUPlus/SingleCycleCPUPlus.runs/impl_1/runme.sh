...
HD_PWD='C:/Users/17727/Desktop/VivadoArea/SingleCycleCPUPlus/SingleCycleCPUPlus.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ToFPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ToFPGA.tcl -notrace
