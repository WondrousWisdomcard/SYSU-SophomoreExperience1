...
HD_PWD='C:/Users/17727/Desktop/VivadoArea/SingleCycleCPUPlus/SingleCycleCPUPlus.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ToFPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ToFPGA.tcl
