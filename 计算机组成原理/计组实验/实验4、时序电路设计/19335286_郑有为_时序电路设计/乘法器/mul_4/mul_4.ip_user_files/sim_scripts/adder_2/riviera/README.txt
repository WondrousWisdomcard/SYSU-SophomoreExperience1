...
#
# Generated by export_simulation on Tue Nov 10 22:49:46 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './adder_2.sh' script.

./adder_2.sh -reset_run
...
./adder_2.sh -noclean_files

For more information on the script, please type './adder_2.sh -help'.
