...
#
# Generated by export_simulation on Tue Nov 10 21:27:04 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './full_adder_0.sh' script.

./full_adder_0.sh -reset_run
...
./full_adder_0.sh -noclean_files

For more information on the script, please type './full_adder_0.sh -help'.
