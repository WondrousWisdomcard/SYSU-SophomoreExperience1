...
HD_PWD='C:/Users/17727/Desktop/VivadoArea/timem/timem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timem.tcl
