...
HD_PWD='C:/Users/17727/Desktop/VivadoArea/timem/timem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timem.tcl -notrace
