...
HD_PWD='C:/Users/17727/Desktop/VivadoArea/pmd2/pmd2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmd2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmd2.tcl -notrace
