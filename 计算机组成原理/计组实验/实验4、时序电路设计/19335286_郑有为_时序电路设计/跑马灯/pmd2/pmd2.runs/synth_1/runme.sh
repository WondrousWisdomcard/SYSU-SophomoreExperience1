...
HD_PWD='C:/Users/17727/Desktop/VivadoArea/pmd2/pmd2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmd2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmd2.tcl
