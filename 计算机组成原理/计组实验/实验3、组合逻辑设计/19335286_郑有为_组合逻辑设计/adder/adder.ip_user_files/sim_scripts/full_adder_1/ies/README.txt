...
#
# Generated by export_simulation on Sun Oct 25 15:08:40 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './full_adder_1.sh' script.

./full_adder_1.sh -reset_run
...
./full_adder_1.sh -noclean_files

For more information on the script, please type './full_adder_1.sh -help'.
